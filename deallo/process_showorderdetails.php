<?php 
	...
	//get order details
	$getOrderQuery = $db_handle->getConn()->prepare("SELECT order_id, customer_id, order_date, status, status_date, order_price, recipient_name, recipient_contact, shipping_address,tracking_number FROM order_details WHERE seller_id = :username AND order_id = :order_id");
