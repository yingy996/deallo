...
<![endif]-->
    ...
    <body data-ng-controller="shoppingBasketCtrl">
        ...
        <?php 
        include("header.php"); 
        include("process_mypurchases.php");
        ?>
						...
						<div class="col-xs-12">
							...
							<span class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="mypurchases.php?sort=orderasc" class="dropdown-item">Ascending</a></li>
									<li><a href="mypurchases.php?sort=orderdesc" class="dropdown-item">Descending</a></li>
									<li class="divider"></li>
									<li class="dropdown-header">Status Date</li>
									<li><a href="mypurchases.php?sort=statusasc" class="dropdown-item">Ascending</a>
									<li><a href="mypurchases.php?sort=statusdesc" class="dropdown-item">Descending</a></li>
								</ul>
							</span>
							...
							<span class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="mypurchases.php?filter=notpaid" class="dropdown-item">Not paid</a></li>
									<li><a href="mypurchases.php?filter=paid" class="dropdown-item">Paid</a></li>
									<li><a href="mypurchases.php?filter=processing" class="dropdown-item">Processing</a>
									<li><a href="mypurchases.php?filter=delivered" class="dropdown-item">Delivered</a></li>
									<li><a href="mypurchases.php?filter=canceled" class="dropdown-item">Canceled</a></li>
								</ul>
							</span>
							&nbsp;
							<a href="mypurchases.php" alt="Reset sorting and filtering" class="btn btn-default">Reset</a>
						</div>
					</div>
					<br/>
								...
								if (count($orderResult) > 0) {
									foreach ($orderResult as $order) {
										...
										echo '<table class="table table-hover ordertable">
											<thead>
												<tr class="active">
													<th colspan="2">Order: '. $order["order_id"] .' &nbsp; &nbsp; &nbsp;  Seller: '. $order["seller_id"] .'</th>
											...
											foreach ($itemResult as $item) {
                                                ...
                                                "<tr class='shoppingcart-product'>
													...
													<div class='media'>
														...
														<img class='img-thumbnail media-object productImg' src='".$itemImg[0]."' style='width: 72px; height: 72px;'>
														</a>
												...
												if ($index == 0) {
													...
													<td class='text-center col-sm-1 col-md-1' rowspan='". count($itemResult) ."'>
														<a href='vieworder.php?orderId=". $order["order_id"] ."' class='btn btn-success'>
